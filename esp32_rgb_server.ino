...
void setRgbColor(uint8_t redValue, uint8_t greenValue, uint8_t blueValue) {
  ...
  ledcWrite(blueChannel, map(blueValue, 0, 255, 0, blueCalibrationLimit));
}
